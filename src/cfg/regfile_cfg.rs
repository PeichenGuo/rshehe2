...
pub const _MSTATUS_SPIE: usize = 0x1 << _MSTATUS_SPIE_LOW;
 // 0_
pub const _MSTATUS_MPIE_LOW: usize = 7;
pub const _MSTATUS_MPIE: usize = 0x1 << _MSTATUS_MPIE_LOW;
pub const _MSTATUS_SPP_LOW: usize = 8;
pub const _MSTATUS_SPP: usize = 0x1 << _MSTATUS_SPP_LOW;
 // 0_
pub const _MSTATUS_MPP_LOW: usize = 11;
pub const _MSTATUS_MPP: usize = 0b11 << _MSTATUS_MPP_LOW;
...
pub const _CSR_MSTATUS_ADDRESS: u16 = 0x300;
...
pub const _CSR_MTVEC_ADDRESS: u16 = 0x305;
pub const _CSR_MSCRATCH_ADDRESS: u16 = 0x340;
pub const CSR_MEPC_ADDRESS: u16 = 0x341;
pub const _CSR_MCAUSE_ADDRESS: u16 = 0x342;
