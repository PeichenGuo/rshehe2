...
#[cfg(test)] mod test {
    ...
    fn isatest_rv64um_mulhu(){
        ...
        core.load_elf("./isa/build/hex/rv64um/mulhu.hex");
        for _i in 0..3000{
            core.tik();
    ...
    fn isatest_rv64um_div(){
        let mut core = HeHeCore::new();
        core.load_elf("./isa/build/hex/rv64um/div.hex");
        for _i in 0..3000{
            core.tik();
            if core.read_from_host() == 1{
                println!("======test succ!======");
    ...
    fn isatest_rv64um_mulh(){
        let mut core = HeHeCore::new();
        core.load_elf("./isa/build/hex/rv64um/mulh.hex");
        for _i in 0..3000{
            core.tik();
            if core.read_from_host() == 1{
                println!("======test succ!======");
    ...
    fn isatest_rv64um_mulhsu(){
        let mut core = HeHeCore::new();
        core.load_elf("./isa/build/hex/rv64um/mulhsu.hex");
        for _i in 0..3000{
            core.tik();
            if core.read_from_host() == 1{
                println!("======test succ!======");
    ...
    fn isatest_rv64um_rem(){
        let mut core = HeHeCore::new();
        core.load_elf("./isa/build/hex/rv64um/rem.hex");
        for _i in 0..3000{
            core.tik();
            if core.read_from_host() == 1{
                println!("======test succ!======");
    ...
    fn isatest_rv64um_mulw(){
        let mut core = HeHeCore::new();
        core.load_elf("./isa/build/hex/rv64um/mulw.hex");
        for _i in 0..3000{
            core.tik();
            if core.read_from_host() == 1{
                println!("======test succ!======");
    ...
    fn isatest_rv64um_divuw(){
        let mut core = HeHeCore::new();
        core.load_elf("./isa/build/hex/rv64um/divuw.hex");
        for _i in 0..3000{
            core.tik();
            if core.read_from_host() == 1{
                println!("======test succ!======");
    ...
    fn isatest_rv64um_remw(){
        let mut core = HeHeCore::new();
        core.load_elf("./isa/build/hex/rv64um/remw.hex");
        for _i in 0..3000{
            core.tik();
            if core.read_from_host() == 1{
                println!("======test succ!======");
    ...
    fn isatest_rv64um_divu(){
        let mut core = HeHeCore::new();
        core.load_elf("./isa/build/hex/rv64um/divu.hex");
        for _i in 0..3000{
            core.tik();
            if core.read_from_host() == 1{
                println!("======test succ!======");
    ...
    fn isatest_rv64um_remuw(){
        let mut core = HeHeCore::new();
        core.load_elf("./isa/build/hex/rv64um/remuw.hex");
        for _i in 0..3000{
            core.tik();
            if core.read_from_host() == 1{
                println!("======test succ!======");
    ...
    fn isatest_rv64um_mul(){
        let mut core = HeHeCore::new();
        core.load_elf("./isa/build/hex/rv64um/mul.hex");
        for _i in 0..3000{
            core.tik();
            if core.read_from_host() == 1{
                println!("======test succ!======");
    ...
    fn isatest_rv64um_divw(){
        let mut core = HeHeCore::new();
        core.load_elf("./isa/build/hex/rv64um/divw.hex");
        for _i in 0..3000{
            core.tik();
            if core.read_from_host() == 1{
                println!("======test succ!======");
    ...
    fn isatest_rv64um_remu(){
        let mut core = HeHeCore::new();
        core.load_elf("./isa/build/hex/rv64um/remu.hex");
        for _i in 0..3000{
            core.tik();
            if core.read_from_host() == 1{
                println!("======test succ!======");
